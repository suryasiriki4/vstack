...
ERR_HINT_MESSAGES = {
    ...
    "ModuleNotFoundError": (
        ...
        "\nif this module can be installed using pip like: 'pip3 install <missing_module>'"
    ),
    "IndexError": (
    ...
    "SyntaxErrorJavaScript": (
        ...
        "\n"
        "\n1- Make sure that any strings in the code have matching quotation marks."
        "\n2- An unclosed bracket – (, {, or [ – makes javascript continue with the next line as part of the current statement."
        "\n   Generally, an error occurs almost immediately in the next line."
        "\n3- Make sure you are not using a javascript keyword for a variable name."
        "\n4- Check that you have a colon at the end of the header of every compound statement,"
        "\n   including for, while, if, and function statements."
        "\n5- Check for the classic '=' instead of '==' in a conditional statement."
        "\nSource: https://www.openbookproject.net/thinkcs/python/english2e/app_a.html"
    ),
    "ZeroDivisionError": (
